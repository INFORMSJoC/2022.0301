...
\pgfplotstableread[col sep=comma]{CG_summary_2021_07_08.csv}\summary{}
...
\begin{table}[H]
	\TABLE{Summary of results for algorithms \textbf{TIF}, \textbf{ATIF} and \textbf{BDDF}: computation time LP relaxation\label{tbl:summarytw}}{
