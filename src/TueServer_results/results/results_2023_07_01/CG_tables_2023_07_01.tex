...
\pgfplotstableread[col sep=comma]{heuristic_summary_2023_07_01.csv}\summary{}
...
\begin{table}[H]
	\TABLE{Summary of results for algorithms \textbf{BKS}, \textbf{NO HEURISTIC} and \textbf{HEURISTIC}\label{tbl:summarytw}}{
		\pgfplotstabletypeset[
			columns={n,m,tot_bb_mean_no_heuristic,opt_sum_no_heuristic,tot_bb_mean_heuristic,opt_sum_heuristic,tot_bb_mean_bks,opt_sum_bks},
			every head row/.style={
					before row={%
							\toprule
							\multicolumn{2}{c}{}&  \multicolumn{2}{c}{\textbf{BKS}}& \multicolumn{2}{c}{\textbf{NO HEURISTIC}} & \multicolumn{2}{c}{\textbf{HEURISTIC}}\\
			...
			columns/tot_bb_mean_no_heuristic/.style={column type=r,fixed,precision=2,zerofill,column name=\emph{Avg sec}},
			columns/opt_sum_no_heuristic/.style={column type=r,fixed,column name=\emph{\# opt}},
			columns/tot_bb_mean_heuristic/.style={column type=r,fixed,precision=2,zerofill,column name=\emph{Avg sec}},
			columns/opt_sum_heuristic/.style={column type=r,,fixed,column name=\emph{\# opt}},
			columns/tot_bb_mean_bks/.style={column type=r,fixed,precision=2,zerofill,column name=\emph{Avg sec}},
			columns/opt_sum_bks/.style={column type=r,fixed,column name=\emph{\# opt}}
		]\summary{}
	}{}
\end{table}
...
% 	\TABLE{Summary of results for algorithms \textbf{TIF}, \textbf{ATIF} and \textbf{BDDF}: gap\label{tbl:summarytw2}}{
% 		\pgfplotstabletypeset[
...
% 	\centering
% 	\TABLE
% 	{Summary of results for algorithms \textbf{TIF}, \textbf{ATIF} and \textbf{BDDF}: Size of graph\label{tbl:sizetw}}
% 	{\pgfplotstabletypeset[
